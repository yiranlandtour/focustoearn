...
function generateConfig(configType, format) {
  ...
  switch (configType) {
    case 'browser':
      switch (format) {
        case 'esm': {
          config.output = [
            {
              file: 'lib/index.browser.esm.price.js',
              format: 'es',
              sourcemap: true,
            },
          ];
        ...
        case 'iife': {
          config.output = [
            {
              file: 'lib/index.iife.price.js',
              format: 'iife',
              name: 'splToken',
              sourcemap: true,
            },
            {
              file: 'lib/index.iife.min.price.js',
              format: 'iife',
              name: 'splToken',
              sourcemap: true,
    ...
    case 'node':
      config.output = [
        {
          file: 'lib/index.cjs.price.js',
          format: 'cjs',
          sourcemap: true,
        },
        {
          file: 'lib/index.esm.price.js',
          format: 'es',
          sourcemap: true,
        },
      ];
