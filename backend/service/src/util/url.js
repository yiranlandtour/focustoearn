...
export const url =
  process.env.RPC_URL ||
  // (process.env.LIVE ? clusterApiUrl(cluster, false) : 'http://localhost:8899'); https://api.mainnet-beta.solana.com
  (process.env.LIVE ? clusterApiUrl(cluster, false) : 'https://api.devnet.solana.com');
// (process.env.LIVE ? clusterApiUrl(cluster, false) : 'https://api.mainnet-beta.solana.com');