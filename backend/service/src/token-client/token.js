 ...
 * class in `@solana/web3.price.js` is different from the bundled `Buffer` class in this package
 */
...
export class Token {
  ...
  async createAssociatedTokenAccountInternal(
    ...
    console.log("associatedAddress pubkey:" + associatedAddress);
